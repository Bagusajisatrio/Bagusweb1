...
<link rel="stylesheet" herf="http://cdn.jsdelivr.net/npm/bootstrap-icons@1.5.0/font/bootstrap-icons.css">
...
<div class="col-lg-4 col-md-6 mb-3 col-sm-6">
  ...
  <div class="card-body">
    <h5 class="card-title">Balado Ayam</h5>
    <p class="card-text">Ayam balado merupakan hidangan khas Indonesia yang menggunakan daging ayam sebagai bahan utamanya dan sambal balado yang menjadi kunci kelezatannya.</p>
...
<div class="col-lg-4 col-md-6 col-sm-6">
  ...
  <div class="card-body">
    ...
    <p class="card-text">gulai ayam biasanya menggunakan gabungan berbagai rempah-rempah khas Nusantara dan disajikan di atas nasi putih hangat.</p>
    <a href="#" class="btn btn-primary">Lihat</a>
  </div>
</div>
<div class="col-lg-4 col-md-6 col-sm-6">
